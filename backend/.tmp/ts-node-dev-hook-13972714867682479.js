"use strict";
var fs = require('fs');
var getCompiledPath = require('/app/node_modules/.pnpm/ts-node-dev@2.0.0_@types+node@25.3.0_typescript@5.9.3/node_modules/ts-node-dev/lib/get-compiled-path').getCompiledPath;
var sep = require('path').sep;
var join = require('path').join;
var extname = require('path').extname;
var execSync = require('child_process').execSync;
var Module = require('module');
var compilationId = '13972714867682479';
var timeThreshold = 0;
var allowJs = true;
var compiledDir = '/app/.ts-node-cache/compiled';
var preferTs = false;
var ignore = [/node_modules/];
var readyFile = '/app/.tmp/ts-node-dev-ready-13972714867682479';
var execCheck = false;
var exitChild = false;
var sourceMapSupportPath = '/app/node_modules/.pnpm/source-map-support@0.5.21/node_modules/source-map-support/source-map-support.js';
var libPath = '/app/node_modules/.pnpm/ts-node-dev@2.0.0_@types+node@25.3.0_typescript@5.9.3/node_modules/ts-node-dev/lib';
var checkFileScript = join("/app/node_modules/.pnpm/ts-node-dev@2.0.0_@types+node@25.3.0_typescript@5.9.3/node_modules/ts-node-dev/lib", 'check-file-exists.js');
