...
ALTER TABLE "products" ADD COLUMN "product_type" "product_type" NOT NULL DEFAULT 'PHYSICAL';--> statement-breakpoint
...
ALTER TABLE "download_logs" ADD CONSTRAINT "download_logs_digital_download_id_digital_downloads_id_fk" FOREIGN KEY ("digital_download_id") REFERENCES "public"."digital_downloads"("id") ON DELETE CASCADE ON UPDATE NO ACTION;--> statement-breakpoint
